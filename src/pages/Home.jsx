...
const Home = () => {
  ...
  const rightPaneWidth = '300px'
  return (
    <Box sx={{display:"flex",justifyContent:{xs:'left',sm:'right'}}}>
        <NavBar drawerWidth={drawerWidth}/>
        <Box sx={{width: {xs:'100%',sm:`calc(100% - ${drawerWidth})`,md:`calc(100% - ${drawerWidth} - ${rightPaneWidth})`},minHeight:'100vh',display:"flex",flexDirection:"column",}}>
            <Outlet />
        </Box>
          
          {/* right pane */}
        <Box sx={{width:`${rightPaneWidth}`, display:{sm:"none",xs:"none",md:"block",padding:'20px',position:'relative', zIndex:'3'}}}>
